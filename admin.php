...
<head>
	...
	<!-- STYLESHEETS -->
	<link rel="stylesheet" type="text/css" href="public/js/extjs/resources/css/ext-all-debug.css" />
	<link rel="stylesheet" type="text/css" href="public/js/dumpJS/dump.css" />
...
<body>
	<!-- JS LIBS -->
	<script type="text/javascript" src="public/js/extjs/ext-debug.js"></script>
	<script type="text/javascript" src="public/js/dumpJS/dump.js"></script>
